            ...
            <div className="fixed bottom-0 left-0 right-0 bg-[#1C1C1E] rounded-t-[30px] p-6 z-50 animate-slide-up max-w-[390px] mx-auto" style={{ borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
                {tradeLink ? (
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-[#999] text-[14px] leading-relaxed">
                                        Стоимость создания обмена составляет <span className="inline-flex items-center gap-1">1 <TonIcon size={16} /></span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <button
                            onClick={handleCreateTrade}
                            className="w-full bg-[#007AFF] rounded-[25px] h-[55px] text-white text-[18px] font-semibold hover:bg-[#0066CC] transition-colors flex items-center justify-center gap-1"
                        >
                            Создать обмен (<span className="inline-flex items-center gap-1">1 <TonIcon size={20} /></span>)
                        </button>
                    </>
                )}
            </div>
