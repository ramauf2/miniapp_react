...
export function TradesHome({ tradeData, tradeHistory, openTradeLink, onOpenTrade, handleCreateTrade, tradeLink, showCreateTradeModal, setShowCreateTradeModal }: TradesHomeProps) {
        ...
        <div className="h-full flex flex-col" style={{ height: 'calc(100vh - 56px)', overflow: 'hidden' }}>
            ...
            <div className="px-4 pt-4 flex-shrink-0" style={{ flexShrink: 0 }}>
                {tradeData && tradeData.partner && (
                    <div 
                        className="bg-[#303030] rounded-[20px] p-4 flex items-center justify-between mb-6" 
                        style={{ 
                ...
                <div className="mb-4 flex justify-center">
                    <div 
                        ...
                        className="bg-[#1A1A1A] rounded-full px-4 py-2 flex items-center gap-2 border border-[#404040] shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]"
                    >
                        <img 
                            src="/images/live.png" 
                            alt="live" 
            ...
            >
                ...
                {tradeHistory.map((trade, index) => (
                    <div 
                        key={index} 
                        className="rounded-[25px] p-3 relative"
                        style={{ 
