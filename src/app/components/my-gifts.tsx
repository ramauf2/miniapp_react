...
export function MyGifts({ onAddGifts, authData }) {
                ...
                {filteredAndSortedGifts.length === 0 ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        {filteredAndSortedGifts.map((gift, index) => (
                            ...
                            >
                                <img src={gift.img} alt={gift.name} className="w-full aspect-square rounded-[12px] object-cover mb-2" />
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <p className="text-white text-[14px] font-semibold flex items-center gap-1">
                                        {gift.price} <TonIcon size={20} />
                                    </p>
                                </div>
                            </div>
                        ))}
                    ...
                    <div className="space-y-4">
                        {filteredAndSortedGifts.map((gift, index) => (
                            ...
                            >
                                <img src={gift.img} alt={gift.name} className="w-[80px] h-[80px] rounded-[12px] object-cover" />
                                ...
                                <div className="text-right">
                                    <p className="text-white text-[18px] font-semibold flex items-center gap-1 justify-end">
                                        {gift.price} <TonIcon size={24} />
                                    </p>
                                </div>
                            </div>
                        ))}
