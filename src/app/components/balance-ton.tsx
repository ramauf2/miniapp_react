...
export function BalanceTon({ui, handleCancelDeposit, blockhainBalance, localBalance}) {
                    ...
                    <>
                        ...
                        <div className="bg-[#303030] rounded-[20px] p-5 mb-6">
                            ...
                            <div className="flex items-center justify-between bg-[#1C1C1E] rounded-[12px] p-3">
                                ...
                                <span className="text-[#007AFF] text-[16px] font-semibold flex items-center gap-1">
                                    {blockhainBalance} <span className="inline-flex items-center" style={{ transform: 'translateY(-1px)' }}><TonIcon size={20} /></span>
                                </span>
                            </div>
                        </div>
                    ...
                    <>
                        ...
                        <div className="bg-[#303030] rounded-[20px] p-5 mb-6">
                            ...
                            <div className="flex items-center justify-between bg-[#1C1C1E] rounded-[12px] p-3">
                                ...
                                <span className="text-[#007AFF] text-[16px] font-semibold flex items-center gap-1">
                                    {localBalance} <span className="inline-flex items-center" style={{ transform: 'translateY(-1px)' }}><TonIcon size={20} /></span>
                                </span>
                            </div>
                        </div>
